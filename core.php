<?php
 if($_POST['apply']) {
   ...
   function __constructor($server, $lezi, $doce, $orar, $dispon, $classroom) {
      $this->server = $server;
      $this->lezi = $lezi;
      $this->doce = $doce;
      $this->orar = $orar;
   ...
   // Query
      ...
      $sq = "UPDATE Aule SET lezione = '$lezi', docente = '$doce', orario = '$orar', disponibilita = '$dispon' WHERE aula = '$classroom'";
